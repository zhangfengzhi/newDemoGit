...
apiready = function(){	
    ...
    api.openFrame ({	
        name: 'show_xxcourse_frame1',	
        url: 'show_xxcourse_frame1.html',	
        rect:{	
            x:0,	
            y:header_h,	
            w:'auto',	
        ...
        bounces: false,	
        delay:200,
        pageParam: {kc_id: kc_id,pxb_id:pxb_id,pxb_id:pxb_id,kc_kj:kc_kj,kc_isbx:kc_isbx,kc_zjr:kc_zjr,kc_dd:kc_dd,kc_name:kc_name},	
    });	
};	