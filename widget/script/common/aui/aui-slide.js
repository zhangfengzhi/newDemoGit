...
(function(window) {
	 ...
	 * 添加监听事件
	 */
	auiSlide.prototype.addTouchEvents = function(){
		this.slideWrap.addEventListener('touchstart', touchStartEvent, false);
		this.slideWrap.addEventListener('touchmove', touchMoveEvent, false);
		this.slideWrap.addEventListener('touchend', touchEndEvent, false);
	}
	
	/**
	 * 移除监听事件
	 */
	auiSlide.prototype.removeTouchEvents = function(){
		this.slideWrap.removeEventListener('touchstart', touchStartEvent, false);
		this.slideWrap.removeEventListener('touchmove', touchMoveEvent, false);
		this.slideWrap.removeEventListener('touchend', touchEndEvent, false);
	}
	// 当分页器为圆点时位置设置
	...
	auiSlide.prototype.setIndex = function(curIndex){
