...
function openSpKqxqWin(type, leave_id, check_status) {
	api.openWin({
		name : 'kaoqinIpad_spKqxq_window',
		url : 'kaoqinIpad_spKqxq_window.html',
		pageParam : {
			header_h : header_h,
			type : type,
			leave_id : leave_id,
...
function opencxKqxqWin(type, leave_id, check_status) {
	api.openWin({
		name : 'kaoqinIpad_cxKqxq_window',
		url : 'kaoqinIpad_cxKqxq_window.html',
		pageParam : {
			header_h : header_h,
			type : type,
			leave_id : leave_id,
...
function openHzlistWin() {
	api.openWin({
		name : 'kaoqinIpad_hzlist_window',
		url : 'kaoqinIpad_hzlist_window.html',
		pageParam : {
			header_h : header_h,
			type : type
		},
...
function openMybcWin(ruleType, leave_id, type) {
	api.openWin({
		name : 'kaoqinIpad_mybc_window',
		url : 'kaoqinIpad_mybc_window.html',
		pageParam : {
			header_h : header_h,
			rule_type : ruleType,
			leave_id : leave_id,
...
function sendSysMsg(kq_type, target_login_name, type, typeName) {
	...
	var is_url = 1;
	var url_name = 'kaoqinIpad_wdkq_window';
	var param_num = 1;
